...
| 반환 값 | Type | Description |
| ------------ | ---- | ----------- |
| <*최솟값*> | 정수 또는 부동 소수점 수 | 지정한 숫자 집합 또는 지정한 배열의 가장 낮은 값 |
||||
...
| 반환 값 | Type | Description |
| ------------ | ---- | ----------- |
| <*나머지*> | 정수 또는 부동 소수점 수 | 첫 번째 숫자를 두 번째 숫자로 나눈 나머지 |
||||
...
| 반환 값 | Type | Description |
| ------------ | ---- | ----------- |
| <*곱셈 결과*> | 정수 또는 부동 소수점 수 | 첫 번째 숫자를 두 번째 숫자로 곱한 결과 |
||||
